<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Success.aspx.cs" Inherits="tudouShop.Success" %>
	...
	<body>
		<!---start-wrap---->
			...
			<div class="header">
				...
				<ul><li><a href="index.html">首页</a> <span> </span></li>
 ...
 <div class="clear"></div>
  ...
  <section id="main" class="entire_width">
    ...
    <div class="container_12">
       <div class="grid_12">
       <h1 class="page_title"><img src="images/success.png" />您已成功付款</h1>
       <p>付款金额：</p> 
     ...
     <div class="bottom-grids">
		...
		<div class="footer">
			<div class="wrap">
				<div class="footer-left">
				<ul><li><a href="index.html">网络文化经营许可证京网文[2011]0168-061号  违法和不良信息举报电话：4006561155  Copyright © 2004-2015  京东JD.com 版权所有</li>
